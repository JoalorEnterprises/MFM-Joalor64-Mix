...
function onCreate()
    makeLuaText('songText', songName .. " " .. currentDifficulty .. " - MFM Joalor64 Mix V1.0.0", 0, 2, 701);
...
function onUpdate(elapsed)
    ...
    setTextString('songText', songName .. " " .. currentDifficulty .. " - MFM Joalor64 Mix V1.0.0");
end
