...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Koii',         'none',             'Composer of Pressure',                                  		'https://www.youtube.com/c/Koii_elde_FNF',  '5EFF8C'],
			['Snowy',         'none',             'Composed Gospel Remix',                                  		'https://www.youtube.com/channel/UCTLNXyWEorMo2h-jZfOj_Vw',  '442691'],
			['SanoBoy7878',         'none',             'Composed Zavodila (Whitty Remix)\nCreator of Sarvente VS. Whitty',                                  		'https://www.youtube.com/c/SanoBoy7878',  '66C9FF'],
