...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Mike Geno',         'mgeno',             'Composer of Mid-Fight Masses\nComposed Zavodila but only Ruv',                                  		'https://www.youtube.com/c/MikeGenoTheElectroWarper',  'FFC200'],
			['Dokki.Doodlez',         'ddoodlez',             'Artist of Mid-Fight Masses\nCharter of Casanova',                                  		'https://twitter.com/dokkidoodlez',  'F592C6'],
			['kuroao_anomal',         'bf',             'Programmer and Charter for Mid-Fight Masses',                                  		'https://twitter.com/Kuroao_Anomal',  '6642F5'],
			['Koii',         'koii',             'Composer of Pressure',                                  		'https://www.youtube.com/c/Koii_elde_FNF',  '5EFF8C'],
			['Snowy',         'snowy',             'Composed Gospel Remix',                                  		'https://www.youtube.com/channel/UCTLNXyWEorMo2h-jZfOj_Vw',  '442691'],
			['SanoBoy7878',         'sano',             'Composed Zavodila (Whitty Remix)\nCreator of Sarvente VS. Whitty',                                  		'https://www.youtube.com/c/SanoBoy7878',  '66C9FF'],
